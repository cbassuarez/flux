...
import { BADGE_ACCENTS, BADGE_FALLBACK_VALUE, BADGE_SIZE_TOKENS, BADGE_THEME_TOKENS, normalizeBadgeValue, } from "./badge-shared.js";
...
export function renderBadgeSvg({ kind, label, value, size = "md", theme = "light", title, }) {
