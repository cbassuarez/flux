import { coerceVersionInfo, formatFluxVersion } from "./index.js";
function selectMarkGlyph() {
...
function renderAnsiColor(char, r, g, b) {
    return `\u001b[38;2;${r};${g};${b}m${char}\u001b[39m`;
}
function lerp(start, end, ratio) {
    return Math.round(start + (end - start) * ratio);
}
function renderOnlineWordmark(wordmark) {
    ...
    return chars
        ...
        return renderAnsiColor(char, lerp(start.r, end.r, ratio), lerp(start.g, end.g, ratio), lerp(start.b, end.b, ratio));
    })
        .join("");
}
function renderOfflineWordmark(wordmark) {
    return `\u001b[2m${wordmark}\u001b[22m`;
}
export function renderCliBrandHeader(opts) {
