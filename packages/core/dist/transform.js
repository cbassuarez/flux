...
const DEFAULT_FIT = "scaleDown";
export function applyAddTransform(source, doc, options) {
...
export function formatFluxSource(source) {
...
function resolveFigureOptions(doc, options) {
    let bankTags = [];
    if (options.bankName) {
